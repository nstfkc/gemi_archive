...
type OrganizationData = Required<
  Parameters<typeof prisma.organization.create>[0]
>["data"];
type OrganizationSaveOptions = Omit<
  Parameters<typeof prisma.organization.create>[0],
  "data"
>;
type MembershipData = Required<
  Parameters<typeof prisma.membership.create>[0]
>["data"];
type MembershipSaveOptions = Omit<
  Parameters<typeof prisma.membership.create>[0],
  "data"
>;
...
type VerificationTokenData = Required<
  Parameters<typeof prisma.verificationToken.create>[0]
>["data"];
type VerificationTokenSaveOptions = Omit<
  Parameters<typeof prisma.verificationToken.create>[0],
  "data"
>;
